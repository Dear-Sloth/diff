...
parser.add_argument('--revinnorm', type=bool, default=True)
parser.add_argument('--is_training', type=int, default=1, help='status')
parser.add_argument('--windownorm', type=bool, default=True)
parser.add_argument('--latent_dim', type=int, default=48, help='latent space dimension')
...
parser.add_argument('--mlp_dim', type=int, default=256, help='mlp dim')  
parser.add_argument('--dropout', type=float, default=0., help='dropout')
parser.add_argument('--skip_dropout', type=float, default=0.5, help='skip dropout')
