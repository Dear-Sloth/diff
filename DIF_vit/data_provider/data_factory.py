...
from data_provider.data_loader_depts import  Dataset_Caiso, Dataset_Production, Dataset_Solar
...
def data_provider(args, flag, return_full_data=False, shuffle_flag_train=True):
    ...
    if args.dataset_name in ['ECL','ETTh1','ETTh2','ETTm1','ETTm2','Exchange','traffic','weather','illness','wind']:
    ...
    elif args.dataset_name in ['caiso', 'production', 'caiso_m', 'production_m', 'synthetic', 'system_KS','solar']:
